...
public class Test {
	public static void main(String[] args) {
		...
		LogModelTransformerManager transformerManager = factory
				.getBean(LogModelTransformerManager.class);
	...
	public static void main2(String[] args) {
		...
		final ClassPathXmlApplicationContext factory = new ClassPathXmlApplicationContext(
				"spring-cinder-xa.xml");
		LogModelService service = factory.getBean(LogModelService.class);
		LogModelVersion<?> logModelVersion = service.getLogModelVersion(
				"3a_play_auth2", "0.0");
		System.out.println(logModelVersion);
