...
import xdata.etl.cinder.gwt.client.ui.user.window.AuthorizesSelectorWindow;
import xdata.etl.cinder.gwt.client.ui.user.window.ShowAuthorizesSelectorWindowEvent;
