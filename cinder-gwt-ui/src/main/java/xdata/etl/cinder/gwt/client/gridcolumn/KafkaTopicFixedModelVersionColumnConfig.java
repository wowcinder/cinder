...
public class KafkaTopicFixedModelVersionColumnConfig {
    ...
    public static ColumnConfig<KafkaTopicFixedModelVersion, xdata.etl.cinder.logmodelmeta.shared.entity.kafka.KafkaTopic.KafkaTopicCharset> charset() {
        ColumnConfig<KafkaTopicFixedModelVersion, xdata.etl.cinder.logmodelmeta.shared.entity.kafka.KafkaTopic.KafkaTopicCharset> charset = new ColumnConfig<KafkaTopicFixedModelVersion, xdata.etl.cinder.logmodelmeta.shared.entity.kafka.KafkaTopic.KafkaTopicCharset>(PropertyUtils.KafkaTopicFixedModelVersionProperty.charset(), 200, "charset");
