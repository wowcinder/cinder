...
import xdata.etl.cinder.gwt.client.service.KafkaRpcServiceAsync;
...
public class RpcServiceUtils {
    ...
    public final static KafkaRpcServiceAsync KafkaRpcService = GWT.create(xdata.etl.cinder.gwt.client.service.KafkaRpcService.class);
